...
const Form = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault(); // تمنع الريلود الافتراضي للفورم

        emailjs
            .sendForm(
                "service_6q5qdj8", // من حسابك EmailJS
                "template_l8izfic", // من حسابك EmailJS
                formRef.current,
                "f8QOARuLwOKHCqwOB" // من حسابك EmailJS
            )
            .then(
                (result) => {
    ...
    return (
        <div>
            <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-gray-600 dark:text-gray-300">
                I'm always open to discussing product design work or partnership opportunities.
            </p>
            <div className="mx-2">
                <form
                    ref={formRef}
                    onSubmit={handleSubmit} // ربط الفورم بالدالة
                ...
                >
                    ...
                    <input type="text" name="country" placeholder="Country*" className={commonClass} required />
                    <input type="tel" name="phone" placeholder="Phone*" className={commonClass} required />
